...
const categorySeeds: SeedCategory[] = [
  {
    ...
    iconFileName: "category_dairy_eggs.jpg",
    color: "#E8F5E9",
  },
  {
    id: "category_bakery",
    ...
    iconFileName: "category_bakery.jpg",
    color: "#FFF3E0",
  },
  {
    ...
    iconFileName: "category_frozen_foods.jpg",
    color: "#E1F5FE",
  },
  {
    ...
    iconFileName: "category_pantry_staples.jpg",
    color: "#FCE4EC",
  },
  {
    ...
    iconFileName: "category_meat_seafood.jpg",
    color: "#F3E5F5",
  },
];
...
const productSeeds: SeedProduct[] = [
  {
    ...
    mainPrice: 15,
    stock: 45,
    imageFileName: "product_perrys_ice_cream_banana_800gm.jpg",
    rating: 4.5,
    reviewCount: 128,
    weight: "800 gm",
  },
  {
    ...
    mainPrice: 15,
    stock: 32,
    imageFileName: "product_vanilla_ice_cream_banana_500gm.jpg",
    rating: 4.3,
    reviewCount: 95,
    weight: "500 gm",
  },
  {
    ...
    mainPrice: 18,
    stock: 28,
    imageFileName: "product_premium_meat_selection_1kg.jpg",
    rating: 4.7,
    reviewCount: 156,
    weight: "1 Kg",
  },
  {
    ...
    mainPrice: 5,
    stock: 120,
    imageFileName: "product_organic_onions_1kg.jpg",
    rating: 4.2,
    reviewCount: 42,
    weight: "1 Kg",
  },
  {
    ...
    mainPrice: 6.5,
    stock: 110,
    imageFileName: "product_fresh_tomatoes_1kg.jpg",
    rating: 4.4,
    reviewCount: 74,
    weight: "1 Kg",
  },
  {
    ...
    mainPrice: 10,
    stock: 67,
    imageFileName: "product_premium_cooking_oil_1litre.jpg",
    rating: 4.6,
    reviewCount: 89,
    weight: "1 Litre",
  },
  {
    ...
    mainPrice: 3.5,
    stock: 200,
    imageFileName: "product_sea_salt_premium_grade_500gm.jpg",
    rating: 4.4,
    reviewCount: 73,
    weight: "500 gm",
  },
  {
    ...
    mainPrice: 15,
    stock: 55,
    imageFileName: "product_mixed_spice_collection_250gm.jpg",
    rating: 4.8,
    reviewCount: 167,
    weight: "250 gm",
  },
  {
    ...
    mainPrice: 4,
    stock: 89,
    imageFileName: "product_fresh_whole_milk_1litre.jpg",
    rating: 4.5,
    reviewCount: 134,
    weight: "1 Litre",
  },
  {
    id: "product_farm_fresh_eggs_dozen",
    name: "Farm Fresh Eggs",
    description: "Farm fresh brown eggs, a dozen per carton",
    categoryId: "category_dairy_eggs",
    category: "Dairy & Eggs",
    price: 4,
    mainPrice: 5,
    stock: 80,
    imageFileName: "product_farm_fresh_eggs_dozen.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "12 pcs",
  },
  {
    id: "product_natural_yogurt_500gm",
    name: "Natural Yogurt",
    ...
    mainPrice: 4,
    stock: 60,
    imageFileName: "product_natural_yogurt_500gm.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "500 gm",
  },
  {
    id: "product_cheddar_cheese_250gm",
    name: "Cheddar Cheese",
    description: "Aged cheddar cheese block, rich and sharp",
    categoryId: "category_dairy_eggs",
    category: "Dairy & Eggs",
    price: 6,
    mainPrice: 7.5,
    stock: 40,
    imageFileName: "product_cheddar_cheese_250gm.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "250 gm",
  },
  {
    id: "product_salted_butter_250gm",
    name: "Salted Butter",
    ...
    mainPrice: 5.5,
    stock: 50,
    imageFileName: "product_salted_butter_250gm.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "250 gm",
  },
  {
    id: "product_white_bread_loaf",
    name: "White Bread Loaf",
    description: "Soft sliced white bread, baked fresh daily",
    categoryId: "category_bakery",
    category: "Bakery",
    price: 2.5,
    mainPrice: 3,
    stock: 70,
    imageFileName: "product_white_bread_loaf.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "400 gm",
  },
  {
    id: "product_whole_wheat_bread_loaf",
    name: "Whole Wheat Bread Loaf",
    description: "Hearty whole wheat bread, high in fiber",
    categoryId: "category_bakery",
    category: "Bakery",
    price: 3,
    mainPrice: 3.5,
    stock: 55,
    imageFileName: "product_whole_wheat_bread_loaf.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "400 gm",
  },
  {
    id: "product_butter_croissants_pack",
    name: "Butter Croissants",
    description: "Flaky butter croissants, baked fresh every morning",
    categoryId: "category_bakery",
    category: "Bakery",
    price: 5,
    mainPrice: 6,
    stock: 35,
    imageFileName: "product_butter_croissants_pack.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "6 pcs",
  },
  {
    id: "product_chocolate_cake",
    name: "Chocolate Cake",
    ...
    mainPrice: 10,
    stock: 20,
    imageFileName: "product_chocolate_cake.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "500 gm",
  },
  {
    id: "product_frozen_green_peas_500gm",
    name: "Frozen Green Peas",
    description: "Flash-frozen green peas, locked-in freshness",
    categoryId: "category_frozen_foods",
    category: "Frozen Foods",
    price: 3,
    mainPrice: 3.5,
    stock: 60,
    imageFileName: "product_frozen_green_peas_500gm.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "500 gm",
  },
  {
    id: "product_frozen_french_fries_1kg",
    name: "Frozen French Fries",
    description: "Crispy frozen french fries, oven or fryer ready",
    categoryId: "category_frozen_foods",
    category: "Frozen Foods",
    price: 4.5,
    mainPrice: 5.5,
    stock: 45,
    imageFileName: "product_frozen_french_fries_1kg.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "1 Kg",
  },
  {
    id: "product_frozen_chicken_drumsticks_1kg",
    name: "Frozen Chicken Drumsticks",
    description: "Frozen chicken drumsticks, ready for grilling or frying",
    categoryId: "category_frozen_foods",
    category: "Frozen Foods",
    price: 8,
    mainPrice: 9.5,
    stock: 35,
    imageFileName: "product_frozen_chicken_drumsticks_1kg.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "1 Kg",
  },
  {
    id: "product_white_rice_2kg",
    name: "White Rice",
    ...
    mainPrice: 7,
    stock: 90,
    imageFileName: "product_white_rice_2kg.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "2 Kg",
  },
  {
    id: "product_white_sugar_1kg",
    name: "White Sugar",
    ...
    mainPrice: 2.5,
    stock: 100,
    imageFileName: "product_white_sugar_1kg.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "1 Kg",
  },
  {
    id: "product_wheat_flour_2kg",
    name: "Wheat Flour",
    ...
    mainPrice: 4.5,
    stock: 85,
    imageFileName: "product_wheat_flour_2kg.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "2 Kg",
  },
  {
    id: "product_spaghetti_pasta_500gm",
    name: "Spaghetti Pasta",
    description: "Durum wheat spaghetti pasta",
    categoryId: "category_pantry_staples",
    category: "Pantry Staples",
    price: 2.8,
    mainPrice: 3.5,
    stock: 75,
    imageFileName: "product_spaghetti_pasta_500gm.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "500 gm",
  },
  {
    id: "product_red_kidney_beans_500gm",
    name: "Red Kidney Beans",
    description: "Dried red kidney beans, protein-rich staple",
    categoryId: "category_pantry_staples",
    category: "Pantry Staples",
    price: 3.2,
    mainPrice: 4,
    stock: 65,
    imageFileName: "product_red_kidney_beans_500gm.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "500 gm",
  },
  {
    id: "product_chicken_breast_fillets_1kg",
    ...
    mainPrice: 13,
    stock: 40,
    imageFileName: "product_chicken_breast_fillets_1kg.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "1 Kg",
  },
  {
    id: "product_fresh_tilapia_fish_1kg",
    name: "Fresh Tilapia Fish",
    description: "Fresh whole tilapia, sourced from local lakes",
    categoryId: "category_meat_seafood",
    category: "Meat & Seafood",
    price: 10,
    mainPrice: 12,
    stock: 25,
    imageFileName: "product_fresh_tilapia_fish_1kg.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "1 Kg",
  },
  {
    id: "product_beef_mince_500gm",
    name: "Beef Mince",
    description: "Fresh lean beef mince, ideal for stews and patties",
    categoryId: "category_meat_seafood",
    category: "Meat & Seafood",
    price: 7.5,
    mainPrice: 9,
    stock: 35,
    imageFileName: "product_beef_mince_500gm.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "500 gm",
  },
  {
    id: "product_pork_chops_500gm",
    name: "Pork Chops",
    description: "Fresh bone-in pork chops",
    categoryId: "category_meat_seafood",
    category: "Meat & Seafood",
    price: 8,
    mainPrice: 9.5,
    stock: 20,
    imageFileName: "product_pork_chops_500gm.jpg",
    rating: 0,
    reviewCount: 0,
    weight: "500 gm",
  },
...
const bundleSeeds: SeedBundle[] = [
  {
    ...
    imageFileName: "bundle_essential_cooking_pack.jpg",
  ...
  },
  {
    ...
    imageFileName: "bundle_premium_spices.jpg",
  ...
  },
  {
    ...
    imageFileName: "bundle_frozen_dessert.jpg",
  ...
  },
  {
    ...
    imageFileName: "bundle_complete_breakfast.jpg",
