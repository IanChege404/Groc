  ...
  static Route? onGenerate(RouteSettings settings) {
    ...
    switch (route) {
      case AppRoutes.splash:
        return CupertinoPageRoute(builder: (_) => const VideoSplashScreen());
      ...
      case AppRoutes.languageSelect:
        return CupertinoPageRoute(builder: (_) => const LanguageSelectScreen());
      ...
      case AppRoutes.deliveryMethod:
        return CupertinoPageRoute(builder: (_) => const DeliveryMethodScreen());

      case AppRoutes.mpesaProcessing:
        final args = settings.arguments as Map<String, dynamic>?;
        return CupertinoPageRoute(
          builder: (_) => MpesaProcessingScreen(
            amount: args?['amount'] ?? 0.0,
            phoneNumber: args?['phoneNumber'] ?? '+254 XXX XXX XXX',
